...
def analyze_file_comprehensive(file_path, resume_only=False):
    ...
    try:
        ...
        # Step 4: Calculate line ratios
        result["commentRatio"] = safe_ratio(result["commentLines"], result["totalLines"])
        result["codeRatio"] = safe_ratio(result["codeLines"], result["totalLines"])
        result["blankRatio"] = safe_ratio(result["blankLines"], result["totalLines"])
        ...
        if resume_only:
            ...
            fileSizeBytes = 0
            function_summary = summarize_function_metrics(result["functions"])
            ...
            resume_result = {
                ...
                "codeRatio": result["codeRatio"],
                "blankRatio": result["blankRatio"],
                ...
                "highComplexityFunctions": result["complexity"].get("highComplexityFunctions", function_summary["highComplexityFunctions"]),
                "criticalComplexityFunctions": result["complexity"].get("criticalComplexityFunctions", function_summary["criticalComplexityFunctions"]),
            ...
            return normalize_output_paths(resume_result)
