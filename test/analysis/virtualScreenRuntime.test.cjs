...
const runtimePath = path.join(projectRoot, 'src', 'codexr-components', 'others', 'virtual-screen', 'virtualScreenRuntime.js');
...
test('virtual screen runtime includes WebRTC broadcasting primitives and shared-room collaboration hooks', () => {
    const multiScreenManagerSource = readProjectFile('src', 'codexr-components', 'others', 'virtual-screen', 'codexrMultiScreenManagerRuntime.js');
    const collaborationRuntimeSource = readProjectFile('src', 'codexr-components', 'others', 'collaboration', 'codexrCollaborationRuntime.js');
    const avatarRuntimeSource = readProjectFile('src', 'codexr-components', 'others', 'avatar', 'codexrAvatarRuntime.js');
