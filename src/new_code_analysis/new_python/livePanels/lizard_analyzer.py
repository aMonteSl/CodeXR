...
def analyze_file(file_path):
    ...
    try:
        ...
        # Check if Lizard could analyze the file
        if analysis is None:
            return {
        ...
        for func in analysis.function_list:
            ...
            function_info = {
                ...
                "startLine": func.start_line,  # JavaScript also checks this property
                "lineEnd": func.end_line,
                "endLine": func.end_line,      # JavaScript also checks this property
                "lineCount": func.nloc,
                "length": func.nloc,           # JavaScript also checks this property
                "complexity": func.cyclomatic_complexity,
                "parameters": len(func.parameters),
                "parameterCount": len(func.parameters),  # JavaScript also checks this property
