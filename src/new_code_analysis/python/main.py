...
def main():
    ...
    parser.add_argument('analysis_type', 
                       choices=['FileLivePanel', 'FileXRAnalysis', 'DOMVisualization', 'DirectoryLivePanel', 'DirectoryLivePanelDeep'],
    ...
    try:
        ...
        if args.analysis_type == 'FileLivePanel':
            ...
            # Call Directory analysis with original sys.argv format
            original_argv = sys.argv
            ...
            # Call Directory Deep analysis with original sys.argv format
            original_argv = sys.argv
