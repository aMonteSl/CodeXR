...
def analyze_directory_comprehensive(directory_path):
    """
    ...
    try:
        ...
        files_to_analyze = scan_directory_files(directory_path)
...
def main():
    ...
    try:
        ...
        analysis_result = analyze_directory_comprehensive(directory_path)
