...
export class ActiveAnalysisTreeItem extends CodeAnalysisTreeItem {
...
export class ActiveAnalysisItemFactory {
     ...
     */
    static createHeaderItem(): CodeAnalysisTreeItem {
        const headerItem = new CodeAnalysisTreeItem(
            'Active Analyses',
     ...
     */
    static createEmptyStateItem(): CodeAnalysisTreeItem {
