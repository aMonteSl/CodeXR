...
import { FileAnalysis, ProjectAnalysis } from '../models/analysisModel';
...
export class AnalysisViewProvider implements vscode.WebviewViewProvider {
   ...
   */
  public showFileAnalysis(analysis: FileAnalysis) {
   ...
   */
  public showProjectAnalysis(analysis: ProjectAnalysis) {
   ...
   */
  private _showFileDetails(filePath: string) {
  ...
  private _getHtmlForWebview(webview: vscode.Webview): string {
    ...
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, 'media', 'analysis', 'main.js')
    );
    
    const styleUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, 'media', 'analysis', 'style.css')
    );
