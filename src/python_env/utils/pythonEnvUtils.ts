...
export class PythonEnvUtils {
     ...
     */
    public static getActivationCommand(venvPath: string): string {
        const platform = os.platform();
     ...
     */
    public static getVenvPythonPath(venvPath: string): string {
        const platform = os.platform();
     ...
     */
    public static getVenvPipPath(venvPath: string): string {
        const platform = os.platform();
     ...
     */
    public static isValidVenv(venvPath: string): boolean {
        try {
