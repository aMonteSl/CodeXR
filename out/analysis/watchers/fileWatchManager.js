...
class FileWatchManager {
    ...
    async handleFileChange(filePath) {
        ...
        if (dataManager_1.analysisDataManager.isFileBeingAnalyzed(filePath)) {
    ...
    async handleStaticReanalysis(filePath) {
        ...
        try {
            ...
            if (visualizationPath) {
                ...
                vscode.window.showInformationMessage(`Analysis updated for ${path.basename(filePath)}`, { modal: false });
            }
            else {
