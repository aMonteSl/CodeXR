...
exports.loadPreviousDirectoryAnalysis = loadPreviousDirectoryAnalysis;
exports.saveDirectoryAnalysisResult = saveDirectoryAnalysisResult;
 ...
 */
async function loadPreviousDirectoryAnalysis(options) {
 ...
 */
async function findOrCreateVisualizationDirectory(context, directoryPath, mode, isProject) {
 ...
 */
async function findExistingVisualizationDir(visualizationsDir, dirName, mode, isProject) {
    try {
 ...
 */
function convertXRDataToDirectoryResult(xrData, directoryPath) {
 ...
 */
async function saveDirectoryAnalysisResult(result, dataPath, mode) {
    try {
        let dataToSave;
        if (mode === 'xr') {
...
//# sourceMappingURL=directoryAnalysisDataManager.js.map