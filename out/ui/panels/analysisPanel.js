 ...
 */
async function loadAnalysisPanelTemplate(webview, extensionUri) {
    // Get paths to resources
    const scriptPath = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'media', 'analysis', 'main.js'));
    const stylePath = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'media', 'analysis', 'style.css'));
 ...
 */
function getInlineAnalysisTemplate(cspSource, nonce, scriptUri, styleUri) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
